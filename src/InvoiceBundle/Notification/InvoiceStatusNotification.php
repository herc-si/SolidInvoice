...
class InvoiceStatusNotification extends NotificationMessage
{
    ...
    final public const string HTML_TEMPLATE = '@AugiasInvoice/Email/status_change.html.twig';

    final public const string TEXT_TEMPLATE = '@AugiasInvoice/Email/status_change.text.twig';
