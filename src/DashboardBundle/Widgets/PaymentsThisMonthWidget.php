...
/**
 * @see \Augias\DashboardBundle\Tests\Widgets\PaymentsThisMonthWidgetTest
 */
#[AsDashboardWidget(
    id: 'payments_this_month',
    label: 'dashboard.widget.payments_this_month',
    icon: 'tabler:calendar-stats',
    zone: WidgetZone::Top,
    priority: 220,
    width: WidgetWidth::Quarter,
)]
final readonly class PaymentsThisMonthWidget implements WidgetInterface
{
    ...
    {
        return '@AugiasDashboard/Widget/stat_payments_this_month.html.twig';
    }
}
