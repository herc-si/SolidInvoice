...
/**
 * Mirrors {@see \SolidInvoice\InvoiceBundle\Enum\InvoiceStatus}'s shape, minus
 ...
 * Invoice, the paid amount is tracked numerically ({@see \SolidInvoice\BillBundle\Entity\Bill::getBalance()}),
