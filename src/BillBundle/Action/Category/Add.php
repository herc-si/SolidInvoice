...
namespace SolidInvoice\BillBundle\Action\Category;

use Doctrine\Persistence\ManagerRegistry;
use SolidInvoice\BillBundle\Entity\BillCategory;
use SolidInvoice\BillBundle\Form\Type\BillCategoryType;
...
final readonly class Add
{
     ...
     */
    #[Template('@SolidInvoiceBill/Category/form.html.twig')]
