...
return App::config([
    'sentry' => [
        'dsn' => env('AUGIAS_SENTRY_DSN'),
        'register_error_listener' => false,
        'register_error_handler' => false,
        'options' => [
            'send_default_pii' => env('AUGIAS_SENTRY_SEND_DEFAULT_PII')
                ->bool(),
            'ignore_exceptions' => [FatalError::class],
            'release' => env('AUGIAS_SENTRY_RELEASE')
                ->default('application_version'),
            'enable_logs' => true,
            // Tracing: set AUGIAS_SENTRY_TRACES_SAMPLE_RATE to a value between 0.0 and 1.0 to enable.
            ...
            'traces_sample_rate' => env('AUGIAS_SENTRY_TRACES_SAMPLE_RATE')
                ->float(),
            ...
            'profiles_sample_rate' => env('AUGIAS_SENTRY_PROFILES_SAMPLE_RATE')
                ->float(),
            ...
            // To use Relay: change AUGIAS_SENTRY_DSN to point to your Relay instance,
            // e.g. http://<key>@localhost:3000/<project-id>, and keep timeouts at 2s.
            'http_timeout' => env('AUGIAS_SENTRY_HTTP_TIMEOUT')
                ->float(),
            'http_connect_timeout' => env('AUGIAS_SENTRY_HTTP_CONNECT_TIMEOUT')
                ->float(),
